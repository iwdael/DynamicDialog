...
public class SuccessTickView extends View {
    ...
    private final float CONST_RADIUS = dip2px(0.8f);
    private final float CONST_RECT_WEIGHT = dip2px(4);
    private final float CONST_LEFT_RECT_W = dip2px(20);
    private final float CONST_RIGHT_RECT_W = dip2px(33);
    private final float MIN_LEFT_RECT_W = dip2px(4.4f);
    private final float MAX_RIGHT_RECT_W = CONST_RIGHT_RECT_W + dip2px(9f);
    ...
    public void startTickAnim() {
        ...
        mAnim.setDuration(750);
        mAnim.setStartOffset(100);
